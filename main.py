...
# =========================
BOT_TOKEN = (os.getenv("BOT_TOKEN") or "8578029081:AAGS7PUoCzaCuHRi7UD5YWEXILTbHTLyX-A").strip()
CHANNEL_ID = int((os.getenv("CHANNEL_ID") or "-1003601376968").strip() or "0")
BOT_USERNAME = (os.getenv("BOT_USERNAME") or "bobacotnow_bot").strip().lstrip("@")
DATABASE_URL = (os.getenv("DATABASE_URL") or "postgresql://postgres:kedaOLuSJLNEtRZaujVAjujGWRPsVuvp@turntable.proxy.rlwy.net:14357/railway").strip()

OWNER_IDS = set()
_raw_owner = (os.getenv("OWNER_IDS") or "7875261276").strip()
